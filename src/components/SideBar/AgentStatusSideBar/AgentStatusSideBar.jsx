  ...
  return (
    <div {...props}>
      <div className="agentStatus">
        ...
        {
          props.dataCount ? <button className="sideBarButton" onClick={props.showModalForAgentStatus}>SEE AGENT
            STATUS</button> : props.agentStatus.map(({fullname, status, status_time, status_color}, index) => {
